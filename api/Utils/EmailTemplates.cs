...
namespace api.Utils
{
    ...
    {
        public static string VerificationEmail(string verificationCode) => $@"<!DOCTYPE html>
        ...
        public static string PasswordRestSuccessEmail() => $@"
                <!DOCTYPE html>
        <html lang=""en"">
        <head>
        <meta charset=""UTF-8"">
        ...
        <div style=""background-color: #F2F2F5; padding: 20px; border-radius: 0 0 5px 5px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);"">
            ...
            <div style=""text-align: center; margin: 30px 0;"">
            <div style=""background-color: #0071E3; color: white; width: 50px; height: 50px; line-height: 50px; border-radius: 50%; display: inline-block; font-size: 30px;"">✓</div>
            </div>
        ...
        ";
        public static string PasswordResetRequestEmail(string resetUrl) => $@"
        <!DOCTYPE html>
        <html lang=""en"">
        <head>
        <meta charset=""UTF-8"">
