    ...
    <div className="h-screen flex items-center justify-center bg-[#f3f4f6]">
      <div className="max-w-4xl w-full mx-auto p-8 md:p-12 bg-white border-[#e6e6e6] rounded-xl shadow-md shadow-[#e6e6e6]">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div>
            <h1 className="text-2xl font-bold text-center text-primary mb-3 font-sans">
              ĐĂNG KÝ
            </h1>
            <p className="text-center text-gray-600 font-medium mb-6 font-sans">
              Tạo tài khoản của bạn ngay hôm nay!
            </p>
            <div>
              <RegisterForm />
              <h1 className="text-sm text-center mt-5 font-semibold text-gray font-sans">
                Bạn đã có tài khoản?
                <Link
